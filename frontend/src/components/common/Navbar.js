...
import { AppBar, Box, Toolbar, Typography, Avatar, InputBase, InputAdornment, IconButton } from '@mui/material';
                ...
                <Toolbar>
                    ...
                    <Box sx={{ flex: 1, display: 'flex', justifyContent: 'flex-end' }}>
                        <Stack direction="row" spacing={2}>
                            ...
                            <Avatar sx={{ cursor: 'pointer' }} alt="Avatar" src="/assets/images/ava.jpg" onClick={() => navigate("/profile")} />
                        </Stack>
                    </Box>
                </Toolbar>

            </AppBar>
            <div style={{ width: '100%', backgroundColor: 'white', height: '0.3px' }}>
